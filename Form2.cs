    ...
    public partial class Form1 : Form
    {
        ...
        private void MainTimerEvent(object sender, EventArgs e)
        {
            ...
            if (player.Bounds.IntersectsWith(door.Bounds) && hasKey == true)
            {
                ...
                GameTimer.Stop();
                MessageBox.Show("تبریک میگم,شما برنده شدید ! " + Environment.NewLine + "Click OK to play again");
                RestartGame();
            }
            ...
            {
                GameTimer.Stop(); 
                MessageBox.Show("شما باختید!" + Environment.NewLine + "Click OK to play again");
                RestartGame();
            }
        }
